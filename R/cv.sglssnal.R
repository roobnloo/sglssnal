...
#'   group \eqn{\ell_2} penalty. Must be in \eqn{[0, 1]}. Default is `0.05`, matching
#'   [sglssnal()] and the sparse-group-lasso literature's own convention (Simon et al.
#'   2013's real-data examples; the `sparsegl` package's `asparse` default).
