...
At that optimum, only a handful of the 36 terms survive, most of them sparse:
...
The selected terms include nucleobase-containing small molecule metabolism
(`GO:0055086`; GTP is riboflavin's direct biosynthetic precursor),
carbohydrate and carbohydrate-derivative metabolism (`GO:0005975`,
`GO:1901135`; energy supply), amino acid metabolism (`GO:0006520`),
transmembrane transport (`GO:0055085`), and regulation of transcription
(`GO:0006355`).

Interestingly, `GO:0006766` (vitamin metabolic process -- the biosynthesis
pathway itself) is not among the selected terms.